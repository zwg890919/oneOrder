    ...
    <div>
        ...
        <el-card class="wrapper-option">
            ...
            <el-table ref="multipleTable" :data="list" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="产品方简称" prop="productOwnShortName">
                </el-table-column>
                <el-table-column label="产品方全称" prop="productSideName">
                </el-table-column>
                <el-table-column prop="fryPay" label="是否受托支付" show-overflow-tooltip>
                    <template slot-scope="scope">
                        {{ scope.row.fryPay == 1 ? '是' : '否' }}
                    </template>
                </el-table-column>
                <el-table-column prop="payAccount" label="受托支付账户" show-overflow-tooltip>
                </el-table-column>
        ...
        <el-dialog :visible.sync="dialogVisible" @close="closeDialog" width="500px" :title="title">
