<template>
  ...
  <div class="login-wrap">
    <div class="ms-title">走易单后台管理系统</div> 
    <div class="ms-login">
      <p class="ms-login__error">{{errorMessage}}</p>
      <el-form :model="formInline">
        <el-form-item>
          <el-input v-model="formInline.userLoginCode" placeholder="请输入用户名"></el-input>
        </el-form-item>
        <el-form-item>
        ...
        <el-form-item>
          <el-row :gutter="20">
            <el-col :span="16">
              <el-input v-model="formInline.verifyCode" placeholder="请输入验证码"></el-input>
            </el-col>
            <el-col :span="4">
              <img src="api/zouyidan_auth/biz/reqVerifyCode" onclick="this.src='api/zouyidan_auth/biz/reqVerifyCode?' + Math.random()">
            </el-col>
...
export default {
  ...
  methods: {
    ...
    addrouter() {
      this.$store
        .dispatch("userLogin", this.formInline)
        .then(() => {
          this.$router.push({ name: "home" });
        })
        .catch(() => {});
