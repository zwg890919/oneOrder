            ...
            <el-tabs type="card" @tab-click="changeStatus">
                <el-tab-pane label="待处理" name="0">
                    <el-table ref="multipleTable" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%">
                        ...
                        <el-table-column label="融资申请编号" min-width="180" prop="t.orderCode">
                        </el-table-column>
                        <el-table-column label="复审任务编号" min-width="150" prop="taskCode">
                        </el-table-column>
                        <el-table-column label="是否首次复审" min-width="150" prop="ifFirst">
                        </el-table-column>
                ...
                <el-tab-pane label="已处理" name="1">
                    <el-table ref="multipleTable" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%">
                        ...
                        <el-table-column label="复审任务编号" min-width="150" prop="applyCode">
                        </el-table-column>
                        <el-table-column label="产品名称" min-width="150" prop="applyTime">
                        </el-table-column>
                        <el-table-column label="借款主体" min-width="150" prop="passTime">
                        </el-table-column>
                        <el-table-column label="复审结果" min-width="120" prop="limit">
                        </el-table-column>
                        <el-table-column label="截止时间" min-width="120" prop="duetime">
                        </el-table-column>
                        <el-table-column label="提交时间" min-width="120" prop="duetime">
                        </el-table-column>
                        <el-table-column label="操作员" min-width="120" prop="duetime">
                        </el-table-column>
                        <el-table-column label="累计时长" min-width="120" prop="duetime">
                        </el-table-column>
                        <el-table-column label="操作" align="center">
                            <template slot-scope="scope">
...
<script>
    export default {
        ...
        methods: {
            ...
            goDispose(row) {
                this.$router.push({ path: 'firstTrialApply', query: { taskId: row.id } })
            }
        }
    }
</script>
